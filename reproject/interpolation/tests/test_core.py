...
def test_blocked_corner_cases():
    ...
    array_reference = reproject_interp(hdu2, hdu1.header, return_footprint=False)

    array_test = reproject_interp(hdu2, hdu1.header, parallel=True, return_footprint=False)
